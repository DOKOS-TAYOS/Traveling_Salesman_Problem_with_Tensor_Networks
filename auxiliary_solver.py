...
#
# Portions of this file are derived from Google's OR-Tools Traveling Salesperson
# Problem (TSP) tutorial sample:
...
#
# Modifications for this repository (tensor inputs, cost helpers, Streamlit /
# benchmark integration) are copyright the project authors and licensed under
# the MIT License; see LICENSE and THIRD_PARTY.md.
# -----------------------------------------------------------------------------
